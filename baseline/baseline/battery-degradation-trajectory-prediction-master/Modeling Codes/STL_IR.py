...
#define sequential model for resistance
...
#only use resistance data
(_,x0),(_,y0)=BuildSeqs(trCap,trIR)
(_,x1),(_,y1)=BuildSeqs(teCap,teIR)
#set checkpoint path
checkpoint_path = "ironly/weight_{epoch:04d}-{val_loss:.2f}.hdf5"
...
#save model
model.save("IROnly.h5")
#tf.keras.utils.plot_model(model,"IROnly.png",show_shapes=True,expand_nested=True)