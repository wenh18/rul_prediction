...
if FROM_SCRATCH:
    ...
    trainer = utils.Trainer(lr=3e-4, n_epochs=num_epochs, device=device, patience=1200,
                      lamda=lamda, alpha=alpha, model_name='./model/wx_inner/wx_inner_pretrain', retreival_set=retrieval_set,
                            train_retrieval_size=10, parts_num_from_each_len=parts_num_per_ratio, scale_ratios=scale_ratios, except_ratios=except_ratios)
